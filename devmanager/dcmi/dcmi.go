...
/*
   ...
   // dcmi
   DCMIDLLEXPORT int (*dcmi_init_func)();
   static int dcmi_init_new(){
   	CALL_FUNC(dcmi_init)
   }

   DCMIDLLEXPORT int (*dcmi_get_card_num_list_func)(int *card_num,int *card_list,int list_length);
   ...
   DCMIDLLEXPORT int (*dcmi_get_device_num_in_card_func)(int card_id,int *device_num);
   ...
   DCMIDLLEXPORT int (*dcmi_get_device_logic_id_func)(int *device_logic_id,int card_id,int device_id);
   ...
   DCMIDLLEXPORT int (*dcmi_create_vdevice_func)(int card_id, int device_id, struct dcmi_create_vdev_res_stru *vdev,
   ...
   DCMIDLLEXPORT int (*dcmi_get_device_info_func)(int card_id, int device_id, enum dcmi_main_cmd main_cmd, unsigned int sub_cmd,
   ...
   DCMIDLLEXPORT int (*dcmi_set_destroy_vdevice_func)(int card_id,int device_id, unsigned int VDevid);
   ...
   DCMIDLLEXPORT int (*dcmi_get_device_type_func)(int card_id,int device_id,enum dcmi_unit_type *device_type);
   ...
   DCMIDLLEXPORT int (*dcmi_get_device_health_func)(int card_id, int device_id, unsigned int *health);
   ...
   DCMIDLLEXPORT int (*dcmi_get_device_utilization_rate_func)(int card_id, int device_id, int input_type,
   ...
   DCMIDLLEXPORT int (*dcmi_get_device_temperature_func)(int card_id, int device_id, int *temperature);
   ...
   DCMIDLLEXPORT int (*dcmi_get_device_voltage_func)(int card_id, int device_id, unsigned int *voltage);
   ...
   DCMIDLLEXPORT int (*dcmi_get_device_power_info_func)(int card_id, int device_id, int *power);
   ...
   DCMIDLLEXPORT int (*dcmi_get_device_frequency_func)(int card_id, int device_id, enum dcmi_freq_type input_type,
   ...
   DCMIDLLEXPORT int (*dcmi_get_device_memory_info_v3_func)(int card_id, int device_id,
   ...
   DCMIDLLEXPORT int (*dcmi_get_device_hbm_info_func)(int card_id, int device_id, struct dcmi_hbm_info *hbm_info);
   ...
   DCMIDLLEXPORT int (*dcmi_get_device_errorcode_v2_func)(int card_id, int device_id, int *error_count, unsigned int *error_code_list,
   ...
   DCMIDLLEXPORT int (*dcmi_get_device_chip_info_func)(int card_id, int device_id, struct dcmi_chip_info *chip_info);
   ...
   DCMIDLLEXPORT int (*dcmi_get_device_phyid_from_logicid_func)(unsigned int logicid, unsigned int *phyid);
   ...
   DCMIDLLEXPORT int (*dcmi_get_device_logicid_from_phyid_func)(unsigned int phyid, unsigned int *logicid);
   ...
   DCMIDLLEXPORT int (*dcmi_get_device_ip_func)(int card_id, int device_id, enum dcmi_port_type input_type, int port_id,
   ...
   DCMIDLLEXPORT int (*dcmi_get_device_network_health_func)(int card_id, int device_id, enum dcmi_rdfx_detect_result *result);
   ...
   DCMIDLLEXPORT int (*dcmi_get_card_list_func)(int *card_num, int *card_list, int list_len);
   int dcmi_get_card_list(int *card_num, int *card_list, int list_len){
    CALL_FUNC(dcmi_get_card_list,card_num,card_list,list_len)
   }

   DCMIDLLEXPORT int (*dcmi_get_device_id_in_card_func)(int card_id, int *device_id_max, int *mcu_id, int *cpu_id);
   ...
   DCMIDLLEXPORT int (*dcmi_get_memory_info_func)(int card_id, int device_id, struct dcmi_memory_info_stru *device_memory_info);
   ...
   DCMIDLLEXPORT int (*dcmi_get_device_errorcode_func)(int card_id, int device_id, int *error_count, unsigned int *error_code,
   int *error_width);
   ...
   DCMIDLLEXPORT int (*dcmi_get_card_id_device_id_from_logicid_func)(int *card_id, int *device_id, unsigned int device_logic_id);
   ...
   DCMIDLLEXPORT int (*dcmi_mcu_get_power_info_func)(int card_id, int *power);
   static int dcmi_mcu_get_power_info_new(int card_id, int *power){
    CALL_FUNC(dcmi_mcu_get_power_info,card_id,power)
   }

   DCMIDLLEXPORT int (*dcmi_get_product_type_func)(int card_id, int device_id, char *product_type_str, int buf_size);
   ...
   DCMIDLLEXPORT int (*dcmi_set_device_reset_func)(int card_id, int device_id, enum dcmi_reset_channel channel_type);
   ...
   DCMIDLLEXPORT int (*dcmi_get_device_boot_status_func)(int card_id, int device_id, enum dcmi_boot_status *boot_status);
   int dcmi_get_device_boot_status(int card_id, int device_id, enum dcmi_boot_status *boot_status){
    ...
    DCMIDLLEXPORT int (*dcmi_subscribe_fault_event_func)(int card_id, int device_id, struct dcmi_event_filter filter,
    ...
    DCMIDLLEXPORT int (*dcmi_get_npu_work_mode_func)(int card_id, unsigned char *work_mode);
    int dcmi_get_npu_work_mode(int card_id, unsigned char *work_mode){
        CALL_FUNC(dcmi_get_npu_work_mode,card_id,work_mode)
    }

    DCMIDLLEXPORT int (*dcmi_get_device_die_v2_func)(int card_id, int device_id, enum dcmi_die_type input_type,
    ...
    DCMIDLLEXPORT int (*dcmi_get_device_resource_info_func)(int card_id, int device_id, struct dcmi_proc_mem_info *proc_info,
    int *proc_num);
    ...
    DCMIDLLEXPORT int (*dcmi_get_device_pcie_info_v2_func)(int card_id, int device_id, struct dcmi_pcie_info_all *pcie_info);
    ...
    DCMIDLLEXPORT int (*dcmi_get_device_board_info_func)(int card_id, int device_id, struct dcmi_board_info *board_info);
